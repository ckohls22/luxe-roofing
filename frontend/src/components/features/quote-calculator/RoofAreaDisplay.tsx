    ...
    <div className="space-y-3">
      {roofPolygons.map((roof, index) => {
        ...
        return (
          <Card
            key={roof.id || index}
            className={`p-4 border rounded-xl shadow-sm transition-opacity duration-200 gap-2 max-w-[300px] m-3 ${
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <Input
                  ...
                  className="accent-orange-500 w-4"
              ...
              <div className="flex  space-x-2">
                ...
                <Button size="icon" variant="ghost" aria-label="Delete Roof">
                  <svg
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 mb-3">
              {SLOPE_OPTIONS.map((opt) => (
                <Button
                  key={opt.value}
                  type="button"
                  variant={slopes[index] === opt.value ? "default" : "outline"}
